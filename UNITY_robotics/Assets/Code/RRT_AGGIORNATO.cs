...
public class RRT_AGGIORNATO : MonoBehaviour
{
    ...
    void BuildRRT()
    {
        ...
        while (i < maxIterations)
        {
            ...
            if (CheckRandomSample(sample))
            {
                ...
                //DA QUI E' DA SISTEMARE CON CheckCurvature + CheckObstacle 
    ...
    */
    ...
    int GetNearestNode(Vector3 sample) //OK, schema su notability
    {
        ...
        lastSample = nodes[nearest - 1]; //assegna il valore del primo nodo su cui calcolare la curvatura (lastaSample-nearest-sample)
    ...
    */
    ...
    bool CheckCurvature() //SINGOLA FUNZIONE CON INPUT SAMPLE, NEAREST E LASTSAMPLE
    {
